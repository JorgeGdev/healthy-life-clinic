  ...
  <div id="site_content">
    ...
    <div id="content">
      ...
      <form method="POST" class="form_settings">
        ...
        <p style="padding-top: 15px"><input class="submit" type="submit" value="Save"></p>
      </form>
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            <button onclick="editPatient(<?php echo $row['patient_id']; ?>, '<?php echo addslashes($row['first_name']); ?>', '<?php echo addslashes($row['last_name']); ?>', '<?php echo $row['email']; ?>', '<?php echo $row['phone']; ?>')">Edit</button>
